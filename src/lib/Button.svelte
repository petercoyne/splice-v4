<script>
	...
	$: if (dark) {
		...
		themeStyle = "text-white bg-sky-400 bg-white bg-opacity-20 hover:bg-opacity-20"
...
shadow-lg hover:shadow-xl active:shadow-inner 
 justify-center items-center rounded-tr-xl rounded-bl-xl {themeStyle}">
	...
	<div class="transition-all uppercase no-underline grow text-center text-sm flex items-center justify-center barlow">
		{#if icon}
